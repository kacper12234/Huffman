...
public class TreeView {
    ...
    public AnchorPane drawTree(Node tree) {

        final AnchorPane treeContainer = new AnchorPane();
        int treeHeight = Node.getHeight(tree);
    ...
    private void drawCircle(Node root, double x, double y, AnchorPane treeAnchorPane) {
    ...
    private void drawBranch(Node root, double x, double y, AnchorPane graphicsContext, double leavesMargin) {
